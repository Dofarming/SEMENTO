...
function dataUpdate() {
  let newData = [];
  newData.push(
    dashboardStore.jobResultAnalysisData["job-result-ratio"][
      "success-percentage"
    ].toFixed(2)
  );
  newData.push(
  ...
  newData = [];
  newData.push(
    dashboardStore.jobResultAnalysisData["job-result-ratio"]["success-work"]
  );
  newData.push(
    dashboardStore.jobResultAnalysisData["job-result-ratio"]["failed-work"]
  );
